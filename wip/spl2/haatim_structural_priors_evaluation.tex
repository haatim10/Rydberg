% =====================================================================
% QUARANTINED -- DO NOT SUBMIT OR FORWARD.  Moved here under PROMPT 16 Part D.
%
% This draft asserts a RETIRED claim: that a matched-adequacy control collapses
% the structural advantage fifteenfold, from +1.209 dB to +0.078 dB. The word
% "fifteen" appears three times and those two numbers four times each. The
% experiment that was meant to establish the collapse -- PROMPT 12 Part C --
% was invalid: its arms were trained with init='random' while the arms they
% were compared against were trained with init='spectral'

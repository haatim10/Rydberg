...
through the same curve. \todo{STEP 0 MEASUREMENT PENDING --- insert measured
value, CI and verdict}
...
predicted the gain on two channel models it was never fitted to, one to within
$0.13$~dB. Paired with an oracle-free rank rule that abstains when no

...
\thanks{A.~Haatim is with the \todo{CONFIRM DEPARTMENT: the string below is
the one used in the earlier HS-GS draft of this project (paper/hsgs.tex),
which is where the original guess came from; it is not an independent source}
